  ...
  return (
    <section id="works">
      ...
      <div className="relative mt-12 mx-auto space-y-16 w-[80%]">
        {/* Project 1 - Veritru (Capstone Project) */}
        <div className="bg-[#EDF0F9] relative flex flex-col-reverse h-[35rem] md:h-[25rem] p-8 rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="relative w-auto lg:w-[25rem] mt-8 lg:my-8 z-10">
            ...
            <p className="my-8 text-gray-600 text-sm mx-0 md:mr-20">
              Veritru is a Web3 fact-checking app that leverages blockchain
              technology to securely and transparently store fact-checked
              articles, combating misinformation with a tamper-proof system.
            </p>
            <Link
